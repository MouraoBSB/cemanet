{{-- Modal "Assinar calendário" de Eventos: <dialog> nativo + Alpine. Abre em `open-assinar`. --}}
@props(['feedUrl'])
...
>
    <dialog
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="assinar-eventos-titulo"
    ...
    >
        <div class="p-6 sm:p-7">
            <div class="flex items-start justify-between gap-4">
                <div>
                    <h2 id="assinar-eventos-titulo" class="font-display text-xl font-semibold text-primary">Assinar calendário</h2>
                    <p class="mt-1 text-sm text-text-secondary">Assine uma vez e os novos eventos do CEMA entram automaticamente no seu calendário.</p>
                </div>
