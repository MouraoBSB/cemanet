...
return [
    ...
    /*
     * Por padrão, converte em fila em produção; em modo sync (testes) roda inline.
     */
    'queue_conversions_by_default' => env('QUEUE_CONNECTION') !== 'sync',
    ...
    'image_optimizers' => [
        ...
        Pngquant::class => [
            '--force', // parâmetro obrigatório
        ],
        Optipng::class => [
            '-i0',    // imagem não-entrelacada
            '-o2',    // nível de otimização 2
            '-quiet', // parâmetro obrigatório
        ],
        Svgo::class => [
            '--disable=cleanupIDs', // evita conflitos de ID em SVG
        ],
        Gifsicle::class => [
            '-b',  // parâmetro obrigatório
            '-O3', // melhor compressão (mais lenta)
        ],
        Cwebp::class => [
            '-q', '80',  // qualidade 80
